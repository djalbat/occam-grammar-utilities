...
_defineProperty(View, "initialContent", "Constructor n/n\n");
...
function florenceLexerFromLexicalPattern(lexicalPattern) {
    var entries = _occamGrammars.FlorenceLexer.entries, custom = lexicalPattern; ///
    entries.unshift({
        custom: custom
    });
